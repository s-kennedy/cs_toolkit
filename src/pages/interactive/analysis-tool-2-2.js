...
const TOOL_TYPE = 'Problem Prioritization Worksheet'

class ProblemPrioritizationPage extends React.Component {
  constructor(props) {
    super(props);
    this.state = {}
  }
...
export default connect(mapStateToProps, mapDispatchToProps)(ProblemPrioritizationPage);
